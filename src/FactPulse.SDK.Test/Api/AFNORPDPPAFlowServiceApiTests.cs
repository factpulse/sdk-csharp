...
namespace FactPulse.SDK.Test.Api
{
    ...
    public sealed class AFNORPDPPAFlowServiceApiTests : ApiTestsBase
    {
        ...
        public async Task DownloadFlowProxyApiV1AfnorFlowV1FlowsFlowIdGetAsyncTest()
        {
            ...
            Client.Option<DocType> docType = default!;
            var response = await _instance.DownloadFlowProxyApiV1AfnorFlowV1FlowsFlowIdGetAsync(flowId, docType);
            var model = response.Ok();
            Assert.IsType<AFNORFlow>(model);
        }
        ...
        {
            AFNORSearchFlowParams aFNORSearchFlowParams = default!;
            var response = await _instance.SearchFlowsProxyApiV1AfnorFlowV1FlowsSearchPostAsync(aFNORSearchFlowParams);
            var model = response.Ok();
            Assert.IsType<AFNORSearchFlowContent>(model);
        }
        ...
        {
            AFNORFlowInfo flowInfo = default!;
            System.IO.Stream file = default!;
            var response = await _instance.SubmitFlowProxyApiV1AfnorFlowV1FlowsPostAsync(flowInfo, file);
            var model = response.Ok();
            Assert.IsType<Object>(model);
        }
    }
