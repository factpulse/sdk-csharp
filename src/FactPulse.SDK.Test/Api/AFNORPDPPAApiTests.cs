...
{
    /// <summary>
    ///  Class for testing AFNORPDPPAApi
    /// </summary>
    public sealed class AFNORPDPPAApiTests : ApiTestsBase
    {
        private readonly IAFNORPDPPAApi _instance;

        public AFNORPDPPAApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IAFNORPDPPAApi>();
        }
        ...
        /// <summary>
        /// Test GetFluxEntrantApiV1AfnorFluxEntrantsFlowIdGet
        /// </summary>
        [Fact (Skip = "not implemented")]
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task OauthTokenProxyApiV1AfnorOauthTokenPostAsyncTest()
        {
            var response = await _instance.OauthTokenProxyApiV1AfnorOauthTokenPostAsync();
            var model = response.Ok();
            Assert.IsType<Object>(model);
        }
    }
