...
namespace FactPulse.SDK.Test.Api
{
    ...
    /// </summary>
    public sealed class DownloadsApiTests : ApiTestsBase
    {
        private readonly IDownloadsApi _instance;

        public DownloadsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDownloadsApi>();
        }

        /// <summary>
        /// Test CheckFileApiV1DownloadDownloadIdHead
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CheckFileApiV1DownloadDownloadIdHeadAsyncTest()
        {
            string downloadId = default!;
            var response = await _instance.CheckFileApiV1DownloadDownloadIdHeadAsync(downloadId);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DownloadFileApiV1DownloadDownloadIdGetAsyncTest()
        {
            string downloadId = default!;
