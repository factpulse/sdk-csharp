...
additionalProperties:
  packageGuid: '{F2F63F6B-098A-47E6-A209-463B524D7B24}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetFluxEntrantApiV1AfnorIncomingFlowsFlowIdGetApiResponse apiResponse = await api.GetFluxEntrantApiV1AfnorIncomingFlowsFlowIdGetAsync("todo");
            IncomingInvoice? model = apiResponse.Ok();
        }
