...
namespace FactPulse.SDK.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new MontantHtTotal1JsonConverter());
            _jsonOptions.Converters.Add(new MontantRemiseGlobaleTtcJsonConverter());
            ...
            _jsonOptions.Converters.Add(new MontantTotalLigneHtJsonConverter());
