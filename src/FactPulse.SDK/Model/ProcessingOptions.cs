...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class ProcessingOptions : IValidatableObject
    {
        /// <summary>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> AutoEnrichOption { get; private set; }

        /// <summary>
        /// Auto-enrich data (Company APIs, Chorus Pro, etc.)
        /// </summary>
        /// <value>Auto-enrich data (Company APIs, Chorus Pro, etc.)</value>
        [JsonPropertyName("autoEnrich")]
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> VerifyDestinationParametersOption { get; private set; }

        /// <summary>
        /// Verify required parameters for destination (e.g., service_code for Chorus)
        /// </summary>
        /// <value>Verify required parameters for destination (e.g., service_code for Chorus)</value>
        [JsonPropertyName("verifyDestinationParameters")]
        public bool? VerifyDestinationParameters { get { return this.VerifyDestinationParametersOption; } set { this.VerifyDestinationParametersOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProcessingOptions" />
    /// </summary>
    public class ProcessingOptionsJsonConverter : JsonConverter<ProcessingOptions>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProcessingOptions" />
        /// </summary>
        ...
        public override ProcessingOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (facturxProfile.IsSet && facturxProfile.Value == null)
                throw new ArgumentNullException(nameof(facturxProfile), "Property is not nullable for class ProcessingOptions.");
        ...
        /// <summary>
        /// Serializes a <see cref="ProcessingOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="processingOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProcessingOptions processingOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, processingOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProcessingOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="processingOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProcessingOptions processingOptions, JsonSerializerOptions jsonSerializerOptions)
        {
