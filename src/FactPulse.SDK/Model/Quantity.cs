...
namespace FactPulse.SDK.Model
{
    ...
    public partial class Quantity : IValidatableObject
    {
        ...
        internal Quantity(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Quantity" />
    /// </summary>
    public class QuantityJsonConverter : JsonConverter<Quantity>
    {
        /// <summary>
        /// Deserializes json to <see cref="Quantity" />
        /// </summary>
        ...
        public override Quantity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Quantity(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Quantity" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="quantity"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Quantity quantity, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="Quantity" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="quantity"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Quantity quantity, JsonSerializerOptions jsonSerializerOptions)
        {
