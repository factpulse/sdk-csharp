...
namespace FactPulse.SDK.Model
{
    ...
    /// Total VAT amount
    /// </summary>
    public partial class Taxamount : IValidatableObject
    {
        /// <summary>
        ...
        internal Taxamount(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Taxamount" />
    /// </summary>
    public class TaxamountJsonConverter : JsonConverter<Taxamount>
    {
        /// <summary>
        /// Deserializes json to <see cref="Taxamount" />
        /// </summary>
        ...
        public override Taxamount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Taxamount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Taxamount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxamount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Taxamount taxamount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taxamount.DecimalOption.IsSet && taxamount.DecimalOption.Value != null)
                writer.WriteNumber("Rate", taxamount.DecimalOption.Value.Value);

            if (taxamount.StringOption.IsSet && taxamount.StringOption.Value != null)
                writer.WriteString("Rate", taxamount.StringOption.Value);

            WriteProperties(writer, taxamount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Taxamount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxamount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Taxamount taxamount, JsonSerializerOptions jsonSerializerOptions)
        {
