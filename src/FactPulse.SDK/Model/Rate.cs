...
namespace FactPulse.SDK.Model
{
    ...
    public partial class Rate : IValidatableObject
    {
        ...
        internal Rate(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Rate" />
    /// </summary>
    public class RateJsonConverter : JsonConverter<Rate>
    {
        /// <summary>
        /// Deserializes json to <see cref="Rate" />
        /// </summary>
        ...
        public override Rate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Rate(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Rate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Rate rate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (rate.DecimalOption.IsSet && rate.DecimalOption.Value != null)
                writer.WriteNumber("1", rate.DecimalOption.Value.Value);

            if (rate.StringOption.IsSet && rate.StringOption.Value != null)
                writer.WriteString("Rate", rate.StringOption.Value);

            WriteProperties(writer, rate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Rate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Rate rate, JsonSerializerOptions jsonSerializerOptions)
        {
