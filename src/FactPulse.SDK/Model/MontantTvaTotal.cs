...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class MontantTvaTotal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MontantTvaTotal" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal MontantTvaTotal(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MontantTvaTotal {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="MontantTvaTotal" />
    /// </summary>
    public class MontantTvaTotalJsonConverter : JsonConverter<MontantTvaTotal>
    {
        /// <summary>
        /// Deserializes json to <see cref="MontantTvaTotal" />
        /// </summary>
        ...
        public override MontantTvaTotal Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new MontantTvaTotal(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="MontantTvaTotal" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="montantTvaTotal"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MontantTvaTotal montantTvaTotal, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (montantTvaTotal.DecimalOption.IsSet && montantTvaTotal.DecimalOption.Value != null)
                writer.WriteNumber("Tauxmanuel", montantTvaTotal.DecimalOption.Value.Value);

            if (montantTvaTotal.StringOption.IsSet && montantTvaTotal.StringOption.Value != null)
                writer.WriteString("Tauxmanuel", montantTvaTotal.StringOption.Value);

            WriteProperties(writer, montantTvaTotal, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MontantTvaTotal" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="montantTvaTotal"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MontantTvaTotal montantTvaTotal, JsonSerializerOptions jsonSerializerOptions)
        {
