...
namespace FactPulse.SDK.Model
{
    ...
    public partial class ValidationInfo : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ValidationInfo(string profile, int schematronRulesPassed, int schematronRulesTotal, Option<bool?> pdfaCompliant = default, Option<bool?> xmlEmbedded = default, Option<List<SchematronValidationError>?> errors = default)
        {
            Profile = profile;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<SchematronValidationError>?> ErrorsOption { get; private set; }

        /// <summary>
        /// Gets or Sets Errors
        /// </summary>
        [JsonPropertyName("errors")]
        public List<SchematronValidationError>? Errors { get { return this.ErrorsOption; } set { this.ErrorsOption = new(value); } }
    ...
    public class ValidationInfoJsonConverter : JsonConverter<ValidationInfo>
    {
        ...
        public override ValidationInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<SchematronValidationError>?> errors = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "xml_embedded":
                            ...
                            break;
                        case "errors":
                            errors = new Option<List<SchematronValidationError>?>(JsonSerializer.Deserialize<List<SchematronValidationError>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
