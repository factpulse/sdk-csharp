...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class Amount2 : IValidatableObject
    {
        /// <summary>
        ...
        internal Amount2(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Amount2" />
    /// </summary>
    public class Amount2JsonConverter : JsonConverter<Amount2>
    {
        /// <summary>
        /// Deserializes json to <see cref="Amount2" />
        /// </summary>
        ...
        public override Amount2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Amount2(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Amount2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="amount2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Amount2 amount2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (amount2.DecimalOption.IsSet && amount2.DecimalOption.Value != null)
                writer.WriteNumber("Rate", amount2.DecimalOption.Value.Value);

            if (amount2.StringOption.IsSet && amount2.StringOption.Value != null)
                writer.WriteString("Rate", amount2.StringOption.Value);

            WriteProperties(writer, amount2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Amount2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="amount2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Amount2 amount2, JsonSerializerOptions jsonSerializerOptions)
        {
