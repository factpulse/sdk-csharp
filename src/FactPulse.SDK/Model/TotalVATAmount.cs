...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class TotalVATAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TotalVATAmount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal TotalVATAmount(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TotalVATAmount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TotalVATAmount" />
    /// </summary>
    public class TotalVATAmountJsonConverter : JsonConverter<TotalVATAmount>
    {
        /// <summary>
        /// Deserializes json to <see cref="TotalVATAmount" />
        /// </summary>
        ...
        public override TotalVATAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TotalVATAmount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TotalVATAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="totalVATAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TotalVATAmount totalVATAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (totalVATAmount.DecimalOption.IsSet && totalVATAmount.DecimalOption.Value != null)
                writer.WriteNumber("VATAmount", totalVATAmount.DecimalOption.Value.Value);

            if (totalVATAmount.StringOption.IsSet && totalVATAmount.StringOption.Value != null)
                writer.WriteString("VATAmount", totalVATAmount.StringOption.Value);

            WriteProperties(writer, totalVATAmount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TotalVATAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="totalVATAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TotalVATAmount totalVATAmount, JsonSerializerOptions jsonSerializerOptions)
        {
