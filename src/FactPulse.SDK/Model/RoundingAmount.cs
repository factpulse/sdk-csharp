...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class RoundingAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundingAmount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal RoundingAmount(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoundingAmount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="RoundingAmount" />
    /// </summary>
    public class RoundingAmountJsonConverter : JsonConverter<RoundingAmount>
    {
        /// <summary>
        /// Deserializes json to <see cref="RoundingAmount" />
        /// </summary>
        ...
        public override RoundingAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new RoundingAmount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="RoundingAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="roundingAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RoundingAmount roundingAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (roundingAmount.DecimalOption.IsSet && roundingAmount.DecimalOption.Value != null)
                writer.WriteNumber("Rate", roundingAmount.DecimalOption.Value.Value);

            if (roundingAmount.StringOption.IsSet && roundingAmount.StringOption.Value != null)
                writer.WriteString("Rate", roundingAmount.StringOption.Value);

            WriteProperties(writer, roundingAmount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RoundingAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="roundingAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RoundingAmount roundingAmount, JsonSerializerOptions jsonSerializerOptions)
        {
