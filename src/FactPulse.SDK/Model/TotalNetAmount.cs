...
namespace FactPulse.SDK.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TotalNetAmount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal TotalNetAmount(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TotalNetAmount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TotalNetAmount" />
    /// </summary>
    public class TotalNetAmountJsonConverter : JsonConverter<TotalNetAmount>
    {
        /// <summary>
        /// Deserializes json to <see cref="TotalNetAmount" />
        /// </summary>
        ...
        public override TotalNetAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TotalNetAmount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TotalNetAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="totalNetAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TotalNetAmount totalNetAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, totalNetAmount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TotalNetAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="totalNetAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TotalNetAmount totalNetAmount, JsonSerializerOptions jsonSerializerOptions)
        {
