...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class TaxableAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxableAmount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal TaxableAmount(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="TaxableAmount" />
    /// </summary>
    public class TaxableAmountJsonConverter : JsonConverter<TaxableAmount>
    {
        /// <summary>
        /// Deserializes json to <see cref="TaxableAmount" />
        /// </summary>
        ...
        public override TaxableAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TaxableAmount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TaxableAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxableAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TaxableAmount taxableAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taxableAmount.DecimalOption.IsSet && taxableAmount.DecimalOption.Value != null)
                writer.WriteNumber("VATAmount", taxableAmount.DecimalOption.Value.Value);

            if (taxableAmount.StringOption.IsSet && taxableAmount.StringOption.Value != null)
                writer.WriteString("VATAmount", taxableAmount.StringOption.Value);

            WriteProperties(writer, taxableAmount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TaxableAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxableAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TaxableAmount taxableAmount, JsonSerializerOptions jsonSerializerOptions)
        {
