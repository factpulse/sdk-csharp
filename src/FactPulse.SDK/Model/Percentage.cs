...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class Percentage : IValidatableObject
    {
        /// <summary>
        ...
        internal Percentage(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Percentage" />
    /// </summary>
    public class PercentageJsonConverter : JsonConverter<Percentage>
    {
        /// <summary>
        /// Deserializes json to <see cref="Percentage" />
        /// </summary>
        ...
        public override Percentage Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Percentage(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Percentage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="percentage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Percentage percentage, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (percentage.DecimalOption.IsSet && percentage.DecimalOption.Value != null)
                writer.WriteNumber("Rate", percentage.DecimalOption.Value.Value);

            if (percentage.StringOption.IsSet && percentage.StringOption.Value != null)
                writer.WriteString("Rate", percentage.StringOption.Value);

            WriteProperties(writer, percentage, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Percentage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="percentage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Percentage percentage, JsonSerializerOptions jsonSerializerOptions)
        {
