...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class VatRate : IValidatableObject
    {
        /// <summary>
        ...
        internal VatRate(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="VatRate" />
    /// </summary>
    public class VatRateJsonConverter : JsonConverter<VatRate>
    {
        /// <summary>
        /// Deserializes json to <see cref="VatRate" />
        /// </summary>
        ...
        public override VatRate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new VatRate(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="VatRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="vatRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, VatRate vatRate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (vatRate.DecimalOption.IsSet && vatRate.DecimalOption.Value != null)
                writer.WriteNumber("Rate", vatRate.DecimalOption.Value.Value);

            if (vatRate.StringOption.IsSet && vatRate.StringOption.Value != null)
                writer.WriteString("Rate", vatRate.StringOption.Value);

            WriteProperties(writer, vatRate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="VatRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="vatRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, VatRate vatRate, JsonSerializerOptions jsonSerializerOptions)
        {
