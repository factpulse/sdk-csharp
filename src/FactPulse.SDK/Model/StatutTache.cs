...
namespace FactPulse.SDK.Model
{
    ...
    public partial class StatutTache : IValidatableObject
    {
        ...
        [JsonConstructor]
        public StatutTache(string idTache, string statut, Option<AnyOf?> resultat = default)
        {
            IdTache = idTache;
            Statut = statut;
        ...
        public Option<AnyOf?> ResultatOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultat
        /// </summary>
        [JsonPropertyName("resultat")]
        public AnyOf? Resultat { get { return this.ResultatOption; } set { this.ResultatOption = new(value); } }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "statut":
                            ...
                            break;
                        case "resultat":
                            resultat = new Option<AnyOf?>(JsonSerializer.Deserialize<AnyOf>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
