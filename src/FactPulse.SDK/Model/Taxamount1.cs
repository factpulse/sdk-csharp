...
namespace FactPulse.SDK.Model
{
    ...
    /// VAT amount
    /// </summary>
    public partial class Taxamount1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Taxamount1" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal Taxamount1(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Taxamount1" />
    /// </summary>
    public class Taxamount1JsonConverter : JsonConverter<Taxamount1>
    {
        /// <summary>
        /// Deserializes json to <see cref="Taxamount1" />
        /// </summary>
        ...
        public override Taxamount1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Taxamount1(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Taxamount1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxamount1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Taxamount1 taxamount1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taxamount1.DecimalOption.IsSet && taxamount1.DecimalOption.Value != null)
                writer.WriteNumber("Rate", taxamount1.DecimalOption.Value.Value);

            if (taxamount1.StringOption.IsSet && taxamount1.StringOption.Value != null)
                writer.WriteString("Rate", taxamount1.StringOption.Value);

            WriteProperties(writer, taxamount1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Taxamount1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxamount1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Taxamount1 taxamount1, JsonSerializerOptions jsonSerializerOptions)
        {
