...
{
    /// <summary>
    /// VAT rate (e.g., 20.00 for 20%)
    /// </summary>
    public partial class Rate1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rate1" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal Rate1(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Rate1" />
    /// </summary>
    public class Rate1JsonConverter : JsonConverter<Rate1>
    {
        /// <summary>
        /// Deserializes json to <see cref="Rate1" />
        /// </summary>
        ...
        public override Rate1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Rate1(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Rate1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rate1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Rate1 rate1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (rate1.DecimalOption.IsSet && rate1.DecimalOption.Value != null)
                writer.WriteNumber("1", rate1.DecimalOption.Value.Value);

            if (rate1.StringOption.IsSet && rate1.StringOption.Value != null)
                writer.WriteString("Rate", rate1.StringOption.Value);

            WriteProperties(writer, rate1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Rate1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rate1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Rate1 rate1, JsonSerializerOptions jsonSerializerOptions)
        {
