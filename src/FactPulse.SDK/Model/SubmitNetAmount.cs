...
namespace FactPulse.SDK.Model
{
    ...
    /// Total net amount
    /// </summary>
    public partial class SubmitNetAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmitNetAmount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal SubmitNetAmount(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubmitNetAmount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="SubmitNetAmount" />
    /// </summary>
    public class SubmitNetAmountJsonConverter : JsonConverter<SubmitNetAmount>
    {
        /// <summary>
        /// Deserializes json to <see cref="SubmitNetAmount" />
        /// </summary>
        ...
        public override SubmitNetAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new SubmitNetAmount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="SubmitNetAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="submitNetAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SubmitNetAmount submitNetAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (submitNetAmount.DecimalOption.IsSet && submitNetAmount.DecimalOption.Value != null)
                writer.WriteNumber("SubmitVatAmount", submitNetAmount.DecimalOption.Value.Value);

            if (submitNetAmount.StringOption.IsSet && submitNetAmount.StringOption.Value != null)
                writer.WriteString("SubmitVatAmount", submitNetAmount.StringOption.Value);

            WriteProperties(writer, submitNetAmount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SubmitNetAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="submitNetAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SubmitNetAmount submitNetAmount, JsonSerializerOptions jsonSerializerOptions)
        {
