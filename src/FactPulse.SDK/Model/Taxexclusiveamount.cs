...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class Taxexclusiveamount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Taxexclusiveamount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal Taxexclusiveamount(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Taxexclusiveamount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Taxexclusiveamount" />
    /// </summary>
    public class TaxexclusiveamountJsonConverter : JsonConverter<Taxexclusiveamount>
    {
        /// <summary>
        /// Deserializes json to <see cref="Taxexclusiveamount" />
        /// </summary>
        ...
        public override Taxexclusiveamount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Taxexclusiveamount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Taxexclusiveamount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxexclusiveamount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Taxexclusiveamount taxexclusiveamount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taxexclusiveamount.DecimalOption.IsSet && taxexclusiveamount.DecimalOption.Value != null)
                writer.WriteNumber("Rate", taxexclusiveamount.DecimalOption.Value.Value);

            if (taxexclusiveamount.StringOption.IsSet && taxexclusiveamount.StringOption.Value != null)
                writer.WriteString("Rate", taxexclusiveamount.StringOption.Value);

            WriteProperties(writer, taxexclusiveamount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Taxexclusiveamount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxexclusiveamount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Taxexclusiveamount taxexclusiveamount, JsonSerializerOptions jsonSerializerOptions)
        {
