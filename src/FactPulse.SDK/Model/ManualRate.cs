...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class ManualRate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualRate" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal ManualRate(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ManualRate" />
    /// </summary>
    public class ManualRateJsonConverter : JsonConverter<ManualRate>
    {
        /// <summary>
        /// Deserializes json to <see cref="ManualRate" />
        /// </summary>
        ...
        public override ManualRate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ManualRate(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ManualRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ManualRate manualRate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (manualRate.DecimalOption.IsSet && manualRate.DecimalOption.Value != null)
                writer.WriteNumber("VATAmount", manualRate.DecimalOption.Value.Value);

            if (manualRate.StringOption.IsSet && manualRate.StringOption.Value != null)
                writer.WriteString("VATAmount", manualRate.StringOption.Value);

            WriteProperties(writer, manualRate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ManualRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="manualRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ManualRate manualRate, JsonSerializerOptions jsonSerializerOptions)
        {
