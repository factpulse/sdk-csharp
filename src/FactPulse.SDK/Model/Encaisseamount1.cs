...
namespace FactPulse.SDK.Model
{
    ...
    /// Encaisseamount1
    /// </summary>
    public partial class Encaisseamount1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Encaisseamount1" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal Encaisseamount1(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Encaisseamount1 {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Encaisseamount1" />
    /// </summary>
    public class Encaisseamount1JsonConverter : JsonConverter<Encaisseamount1>
    {
        /// <summary>
        /// Deserializes json to <see cref="Encaisseamount1" />
        /// </summary>
        ...
        public override Encaisseamount1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Encaisseamount1(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Encaisseamount1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="encaisseamount1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Encaisseamount1 encaisseamount1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (encaisseamount1.DecimalOption.IsSet && encaisseamount1.DecimalOption.Value != null)
                writer.WriteNumber("Rate", encaisseamount1.DecimalOption.Value.Value);

            if (encaisseamount1.StringOption.IsSet && encaisseamount1.StringOption.Value != null)
                writer.WriteString("Rate", encaisseamount1.StringOption.Value);

            WriteProperties(writer, encaisseamount1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Encaisseamount1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="encaisseamount1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Encaisseamount1 encaisseamount1, JsonSerializerOptions jsonSerializerOptions)
        {
