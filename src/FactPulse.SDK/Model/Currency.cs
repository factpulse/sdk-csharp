...
{
    /// <summary>
    /// Currency code (ISO 4217). See CurrencyCode enum for valid values.
    /// </summary>
    public partial class Currency : IValidatableObject
    {
        ...
        internal Currency(Option<CurrencyCode?> currencyCode, Option<string?> @string)
        {
        ...
        public Option<CurrencyCode?> CurrencyCodeOption { get; private set; }

        /// <summary>
        /// Gets or Sets CurrencyCode
        /// </summary>
        public CurrencyCode? CurrencyCode { get { return this.CurrencyCodeOption; } set { this.CurrencyCodeOption = new(value); } }
    ...
    public class CurrencyJsonConverter : JsonConverter<Currency>
    {
        ...
        public override Currency Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReaderAnyOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderCurrencyCode = utf8JsonReader;
                    ClientUtils.TryDeserialize<CurrencyCode?>(ref utf8JsonReaderCurrencyCode, jsonSerializerOptions, out currencyCode);
            ...
            Option<CurrencyCode?> currencyCodeParsedValue = currencyCode == null
                ? default
                : new Option<CurrencyCode?>(currencyCode);
            Option<string?> varStringParsedValue = varString == null
                ? default
                : new Option<string?>(varString);

            return new Currency(currencyCodeParsedValue, varStringParsedValue);
        }
        ...
        public override void Write(Utf8JsonWriter writer, Currency currency, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.CurrencyCodeOption.IsSet && currency.CurrencyCodeOption.Value != null)
            {
                CurrencyCodeJsonConverter currencyCodeJsonConverter = (CurrencyCodeJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(currency.CurrencyCodeOption.Value.GetType()));
                currencyCodeJsonConverter.Write(writer, currency.CurrencyCodeOption.Value.Value, jsonSerializerOptions);
            }

            if (currency.StringOption.IsSet && currency.StringOption.Value != null)
                writer.WriteString("Sellercountry", currency.StringOption.Value);
