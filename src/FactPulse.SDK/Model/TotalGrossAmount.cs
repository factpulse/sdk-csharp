...
namespace FactPulse.SDK.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TotalGrossAmount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal TotalGrossAmount(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TotalGrossAmount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TotalGrossAmount" />
    /// </summary>
    public class TotalGrossAmountJsonConverter : JsonConverter<TotalGrossAmount>
    {
        /// <summary>
        /// Deserializes json to <see cref="TotalGrossAmount" />
        /// </summary>
        ...
        public override TotalGrossAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TotalGrossAmount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TotalGrossAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="totalGrossAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TotalGrossAmount totalGrossAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, totalGrossAmount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TotalGrossAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="totalGrossAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TotalGrossAmount totalGrossAmount, JsonSerializerOptions jsonSerializerOptions)
        {
