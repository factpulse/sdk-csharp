...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class PriceBasisQuantity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceBasisQuantity" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal PriceBasisQuantity(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceBasisQuantity {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="PriceBasisQuantity" />
    /// </summary>
    public class PriceBasisQuantityJsonConverter : JsonConverter<PriceBasisQuantity>
    {
        /// <summary>
        /// Deserializes json to <see cref="PriceBasisQuantity" />
        /// </summary>
        ...
        public override PriceBasisQuantity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PriceBasisQuantity(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="PriceBasisQuantity" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="priceBasisQuantity"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PriceBasisQuantity priceBasisQuantity, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (priceBasisQuantity.DecimalOption.IsSet && priceBasisQuantity.DecimalOption.Value != null)
                writer.WriteNumber("Rate", priceBasisQuantity.DecimalOption.Value.Value);

            if (priceBasisQuantity.StringOption.IsSet && priceBasisQuantity.StringOption.Value != null)
                writer.WriteString("Rate", priceBasisQuantity.StringOption.Value);

            WriteProperties(writer, priceBasisQuantity, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PriceBasisQuantity" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="priceBasisQuantity"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PriceBasisQuantity priceBasisQuantity, JsonSerializerOptions jsonSerializerOptions)
        {
