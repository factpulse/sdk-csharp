...
namespace FactPulse.SDK.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AmountDue" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal AmountDue(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="AmountDue" />
    /// </summary>
    public class AmountDueJsonConverter : JsonConverter<AmountDue>
    {
        /// <summary>
        /// Deserializes json to <see cref="AmountDue" />
        /// </summary>
        ...
        public override AmountDue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AmountDue(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="AmountDue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="amountDue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AmountDue amountDue, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, amountDue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AmountDue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="amountDue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AmountDue amountDue, JsonSerializerOptions jsonSerializerOptions)
        {
