...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class BaseAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseAmount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal BaseAmount(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="BaseAmount" />
    /// </summary>
    public class BaseAmountJsonConverter : JsonConverter<BaseAmount>
    {
        /// <summary>
        /// Deserializes json to <see cref="BaseAmount" />
        /// </summary>
        ...
        public override BaseAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new BaseAmount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="BaseAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="baseAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BaseAmount baseAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (baseAmount.DecimalOption.IsSet && baseAmount.DecimalOption.Value != null)
                writer.WriteNumber("Rate", baseAmount.DecimalOption.Value.Value);

            if (baseAmount.StringOption.IsSet && baseAmount.StringOption.Value != null)
                writer.WriteString("Rate", baseAmount.StringOption.Value);

            WriteProperties(writer, baseAmount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BaseAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="baseAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BaseAmount baseAmount, JsonSerializerOptions jsonSerializerOptions)
        {
