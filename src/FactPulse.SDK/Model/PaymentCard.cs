...
namespace FactPulse.SDK.Model
{
    ...
    public partial class PaymentCard : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PaymentCard(Option<string?> cardId = default, Option<string?> cardholderName = default)
        {
            CardIdOption = cardId;
        ...
        public string? CardholderName { get { return this.CardholderNameOption; } set { this.CardholderNameOption = new(value); } }
    ...
    public class PaymentCardJsonConverter : JsonConverter<PaymentCard>
    {
        ...
        public override PaymentCard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PaymentCard(cardId, cardholderName);
        }
        ...
        {
            if (paymentCard.CardIdOption.IsSet)
                if (paymentCard.CardIdOption.Value != null)
                    writer.WriteString("card_id", paymentCard.CardId);
                else
                    writer.WriteNull("card_id");

            if (paymentCard.CardholderNameOption.IsSet)
                if (paymentCard.CardholderNameOption.Value != null)
                    writer.WriteString("cardholder_name", paymentCard.CardholderName);
                else
                    writer.WriteNull("cardholder_name");
        }
    }
}
