...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class CredentialsChorusPro : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CredentialsChorusPro" /> class.
        /// </summary>
        ...
        /// <param name="modeSandbox">[MODE 2] Utiliser le mode sandbox (défaut: True) (default to true)</param>
        [JsonConstructor]
        public CredentialsChorusPro(Option<string?> pisteClientId = default, Option<string?> pisteClientSecret = default, Option<string?> chorusLogin = default, Option<string?> chorusPassword = default, Option<bool?> modeSandbox = default)
        {
        ...
        /// </summary>
        [JsonPropertyName("chorus_password")]
        ...
        /// </summary>
        /// <value>[MODE 2] Utiliser le mode sandbox (défaut: True)</value>
        [JsonPropertyName("mode_sandbox")]
    ...
    /// <summary>
    /// A Json converter for type <see cref="CredentialsChorusPro" />
    /// </summary>
    public class CredentialsChorusProJsonConverter : JsonConverter<CredentialsChorusPro>
    {
        /// <summary>
        /// Deserializes json to <see cref="CredentialsChorusPro" />
        /// </summary>
        ...
        public override CredentialsChorusPro Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modeSandbox.IsSet && modeSandbox.Value == null)
                throw new ArgumentNullException(nameof(modeSandbox), "Property is not nullable for class CredentialsChorusPro.");

            return new CredentialsChorusPro(pisteClientId, pisteClientSecret, chorusLogin, chorusPassword, modeSandbox);
        }

        /// <summary>
        /// Serializes a <see cref="CredentialsChorusPro" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="credentialsChorusPro"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CredentialsChorusPro credentialsChorusPro, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, credentialsChorusPro, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CredentialsChorusPro" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="credentialsChorusPro"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CredentialsChorusPro credentialsChorusPro, JsonSerializerOptions jsonSerializerOptions)
        {
            if (credentialsChorusPro.PisteClientIdOption.IsSet)
                if (credentialsChorusPro.PisteClientIdOption.Value != null)
                    writer.WriteString("piste_client_id", credentialsChorusPro.PisteClientId);
                else
                    writer.WriteNull("piste_client_id");

            if (credentialsChorusPro.PisteClientSecretOption.IsSet)
                if (credentialsChorusPro.PisteClientSecretOption.Value != null)
                    writer.WriteString("piste_client_secret", credentialsChorusPro.PisteClientSecret);
                else
                    writer.WriteNull("piste_client_secret");

            if (credentialsChorusPro.ChorusLoginOption.IsSet)
                if (credentialsChorusPro.ChorusLoginOption.Value != null)
                    writer.WriteString("chorus_login", credentialsChorusPro.ChorusLogin);
                else
                    writer.WriteNull("chorus_login");

            if (credentialsChorusPro.ChorusPasswordOption.IsSet)
                if (credentialsChorusPro.ChorusPasswordOption.Value != null)
                    writer.WriteString("chorus_password", credentialsChorusPro.ChorusPassword);
                else
                    writer.WriteNull("chorus_password");

            if (credentialsChorusPro.ModeSandboxOption.IsSet)
                writer.WriteBoolean("mode_sandbox", credentialsChorusPro.ModeSandboxOption.Value!.Value);
        }
    }
}
