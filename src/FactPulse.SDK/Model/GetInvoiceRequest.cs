...
namespace FactPulse.SDK.Model
{
    ...
    /// Get an invoice.
    /// </summary>
    public partial class GetInvoiceRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInvoiceRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetInvoiceRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetInvoiceRequest" />
    /// </summary>
    public class GetInvoiceRequestJsonConverter : JsonConverter<GetInvoiceRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetInvoiceRequest" />
        /// </summary>
        ...
        public override GetInvoiceRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!chorusInvoiceId.IsSet)
                throw new ArgumentException("Property is required for class GetInvoiceRequest.", nameof(chorusInvoiceId));

            if (chorusInvoiceId.IsSet && chorusInvoiceId.Value == null)
                throw new ArgumentNullException(nameof(chorusInvoiceId), "Property is not nullable for class GetInvoiceRequest.");

            return new GetInvoiceRequest(chorusInvoiceId.Value!.Value!, credentials);
        }

        /// <summary>
        /// Serializes a <see cref="GetInvoiceRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getInvoiceRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetInvoiceRequest getInvoiceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getInvoiceRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetInvoiceRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getInvoiceRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, GetInvoiceRequest getInvoiceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (getInvoiceRequest.CredentialsOption.IsSet)
                if (getInvoiceRequest.CredentialsOption.Value != null)
                {
                    ...
                    JsonSerializer.Serialize(writer, getInvoiceRequest.Credentials, jsonSerializerOptions);
                }
                else
