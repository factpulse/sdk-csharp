...
namespace FactPulse.SDK.Model
{
    ...
    /// VAT amount
    /// </summary>
    public partial class Taxamount2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Taxamount2" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal Taxamount2(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Taxamount2" />
    /// </summary>
    public class Taxamount2JsonConverter : JsonConverter<Taxamount2>
    {
        /// <summary>
        /// Deserializes json to <see cref="Taxamount2" />
        /// </summary>
        ...
        public override Taxamount2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Taxamount2(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Taxamount2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxamount2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Taxamount2 taxamount2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taxamount2.DecimalOption.IsSet && taxamount2.DecimalOption.Value != null)
                writer.WriteNumber("Rate", taxamount2.DecimalOption.Value.Value);

            if (taxamount2.StringOption.IsSet && taxamount2.StringOption.Value != null)
                writer.WriteString("Rate", taxamount2.StringOption.Value);

            WriteProperties(writer, taxamount2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Taxamount2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taxamount2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Taxamount2 taxamount2, JsonSerializerOptions jsonSerializerOptions)
        {
