...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class GrossUnitPrice : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GrossUnitPrice" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal GrossUnitPrice(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GrossUnitPrice {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="GrossUnitPrice" />
    /// </summary>
    public class GrossUnitPriceJsonConverter : JsonConverter<GrossUnitPrice>
    {
        /// <summary>
        /// Deserializes json to <see cref="GrossUnitPrice" />
        /// </summary>
        ...
        public override GrossUnitPrice Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GrossUnitPrice(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="GrossUnitPrice" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="grossUnitPrice"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GrossUnitPrice grossUnitPrice, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (grossUnitPrice.DecimalOption.IsSet && grossUnitPrice.DecimalOption.Value != null)
                writer.WriteNumber("Rate", grossUnitPrice.DecimalOption.Value.Value);

            if (grossUnitPrice.StringOption.IsSet && grossUnitPrice.StringOption.Value != null)
                writer.WriteString("Rate", grossUnitPrice.StringOption.Value);

            WriteProperties(writer, grossUnitPrice, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GrossUnitPrice" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="grossUnitPrice"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GrossUnitPrice grossUnitPrice, JsonSerializerOptions jsonSerializerOptions)
        {
