...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class ChargeTotalAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeTotalAmount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal ChargeTotalAmount(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargeTotalAmount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ChargeTotalAmount" />
    /// </summary>
    public class ChargeTotalAmountJsonConverter : JsonConverter<ChargeTotalAmount>
    {
        /// <summary>
        /// Deserializes json to <see cref="ChargeTotalAmount" />
        /// </summary>
        ...
        public override ChargeTotalAmount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ChargeTotalAmount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ChargeTotalAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="chargeTotalAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ChargeTotalAmount chargeTotalAmount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (chargeTotalAmount.DecimalOption.IsSet && chargeTotalAmount.DecimalOption.Value != null)
                writer.WriteNumber("Rate", chargeTotalAmount.DecimalOption.Value.Value);

            if (chargeTotalAmount.StringOption.IsSet && chargeTotalAmount.StringOption.Value != null)
                writer.WriteString("Rate", chargeTotalAmount.StringOption.Value);

            WriteProperties(writer, chargeTotalAmount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ChargeTotalAmount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="chargeTotalAmount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ChargeTotalAmount chargeTotalAmount, JsonSerializerOptions jsonSerializerOptions)
        {
