...
namespace FactPulse.SDK.Model
{
    ...
    public partial class Amount1 : IValidatableObject
    {
        ...
        internal Amount1(Option<decimal?> @decimal, Option<string?> @string)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="Amount1" />
    /// </summary>
    public class Amount1JsonConverter : JsonConverter<Amount1>
    {
        /// <summary>
        /// Deserializes json to <see cref="Amount1" />
        /// </summary>
        ...
        public override Amount1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Amount1(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Amount1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="amount1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Amount1 amount1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (amount1.DecimalOption.IsSet && amount1.DecimalOption.Value != null)
                writer.WriteNumber("Rate", amount1.DecimalOption.Value.Value);

            if (amount1.StringOption.IsSet && amount1.StringOption.Value != null)
                writer.WriteString("Rate", amount1.StringOption.Value);

            WriteProperties(writer, amount1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Amount1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="amount1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Amount1 amount1, JsonSerializerOptions jsonSerializerOptions)
        {
