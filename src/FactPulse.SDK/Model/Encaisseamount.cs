...
namespace FactPulse.SDK.Model
{
    ...
    /// </summary>
    public partial class Encaisseamount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Encaisseamount" /> class.
        /// </summary>
        /// <param name="decimal"></param>
        /// <param name="string"></param>
        internal Encaisseamount(Option<decimal?> @decimal, Option<string?> @string)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Encaisseamount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Encaisseamount" />
    /// </summary>
    public class EncaisseamountJsonConverter : JsonConverter<Encaisseamount>
    {
        /// <summary>
        /// Deserializes json to <see cref="Encaisseamount" />
        /// </summary>
        ...
        public override Encaisseamount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Encaisseamount(varDecimalParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Encaisseamount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="encaisseamount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Encaisseamount encaisseamount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (encaisseamount.DecimalOption.IsSet && encaisseamount.DecimalOption.Value != null)
                writer.WriteNumber("Rate", encaisseamount.DecimalOption.Value.Value);

            if (encaisseamount.StringOption.IsSet && encaisseamount.StringOption.Value != null)
                writer.WriteString("Rate", encaisseamount.StringOption.Value);

            WriteProperties(writer, encaisseamount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Encaisseamount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="encaisseamount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Encaisseamount encaisseamount, JsonSerializerOptions jsonSerializerOptions)
        {
