...
namespace FactPulse.SDK.Model
{
    ...
    public partial class CadreDeFacturation : IValidatableObject
    {
        ...
        public Option<string?> CodeServiceValideurOption { get; private set; }

        /// <summary>
        /// Gets or Sets CodeServiceValideur
        /// </summary>
        [JsonPropertyName("codeServiceValideur")]
        public string? CodeServiceValideur { get { return this.CodeServiceValideurOption; } set { this.CodeServiceValideurOption = new(value); } }

        /// <summary>
        /// Used to track the state of CodeStructureValideur
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> CodeStructureValideurOption { get; private set; }

        /// <summary>
        /// Gets or Sets CodeStructureValideur
        /// </summary>
        [JsonPropertyName("codeStructureValideur")]
        public string? CodeStructureValideur { get { return this.CodeStructureValideurOption; } set { this.CodeStructureValideurOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CadreDeFacturation" />
    /// </summary>
    public class CadreDeFacturationJsonConverter : JsonConverter<CadreDeFacturation>
    {
        /// <summary>
        /// Deserializes json to <see cref="CadreDeFacturation" />
        /// </summary>
        ...
        public override CadreDeFacturation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "codeCadreFacturation":
                            string? codeCadreFacturationRawValue = utf8JsonReader.GetString();
                        ...
                        case "codeServiceValideur":
                            ...
                            break;
                        case "codeStructureValideur":
                            codeStructureValideur = new Option<string?>(utf8JsonReader.GetString());
                            break;
                        default:
                            break;
                    }
            ...
            if (!codeCadreFacturation.IsSet)
                throw new ArgumentException("Property is required for class CadreDeFacturation.", nameof(codeCadreFacturation));
        ...
        /// <summary>
        /// Serializes a <see cref="CadreDeFacturation" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cadreDeFacturation"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CadreDeFacturation cadreDeFacturation, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, cadreDeFacturation, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CadreDeFacturation" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cadreDeFacturation"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CadreDeFacturation cadreDeFacturation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cadreDeFacturation.CodeServiceValideurOption.IsSet)
                if (cadreDeFacturation.CodeServiceValideurOption.Value != null)
                    ...
                    writer.WriteNull("codeServiceValideur");

            if (cadreDeFacturation.CodeStructureValideurOption.IsSet)
                if (cadreDeFacturation.CodeStructureValideurOption.Value != null)
                    writer.WriteString("codeStructureValideur", cadreDeFacturation.CodeStructureValideur);
                else
                    writer.WriteNull("codeStructureValideur");
        }
    }
}
