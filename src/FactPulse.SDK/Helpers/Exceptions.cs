...
namespace FactPulse.SDK.Helpers
{
    ...
    public class FactPulseAuthException : FactPulseException { public FactPulseAuthException(string msg = "Erreur d'authentification") : base(msg) { } }
    public class FactPulsePollingTimeoutException : FactPulseException {
        public string TaskId { get; }
        public long Timeout { get; }
        public FactPulsePollingTimeoutException(string taskId, long timeout) : base($"Timeout ({timeout}ms) atteint pour la tâche {taskId}") { TaskId = taskId; Timeout = timeout; }
    }
